...
def build_prompt(tokenizer: Any, payload: dict[str, Any], strict: bool) -> str:
  ...
  instruction = (
    ...
    "- invoiceNumber is the human-readable invoice or bill number assigned by the issuer; reject IRN (64-character hex), Ack No (15+ digit number), PO numbers, Ref numbers, and Order numbers; for proforma invoices extract the proforma invoice number\n"
    "- Prefer grand total / total / amount payable rows for totalAmountMinor; reject subtotal, taxable value, and individual tax amounts\n"
